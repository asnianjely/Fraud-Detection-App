...
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=DM+Serif+Display&family=Inter:wght@300;400;500;600&family=IBM+Plex+Mono:wght@400;500&display=swap');
...
.verdict-safe    { color: #1A6B4A; }
.verdict-caution { color: #B8860B; }
.verdict-fraud   { color: #C8102E; }
.verdict-sub {
    font-size: 13px;
    color: #8B9AB8;
    font-weight: 400;
...
.factor-bar-fill { height: 100%; position: absolute; left: 0; }
.factor-score {
    font-family: 'IBM Plex Mono', monospace;
    font-size: 11px;
    font-weight: 500;
...
.factor-positive { color: #C8102E; }
.factor-negative { color: #1A6B4A; }
...
.rec-box.safe    { border-color: #1A6B4A; }
.rec-box.caution { border-color: #B8860B; }
.rec-box.fraud   { border-color: #C8102E; }
.rec-label {
    font-family: 'IBM Plex Mono', monospace;
    font-size: 10px;
    letter-spacing: 0.12em;
...
.rec-label.safe    { color: #1A6B4A; }
.rec-label.caution { color: #B8860B; }
.rec-label.fraud   { color: #C8102E; }
.rec-text { font-size: 13px; color: #8B9AB8; line-height: 1.6; }
...
<div class="topbar">
  ...
  <div class="topbar-right">
    ...
    <span style="font-family:'IBM Plex Mono',monospace;font-size:11px;color:#4A5270">
...
with left_col:
    st.markdown('<div style="padding:32px 36px 36px;">', unsafe_allow_html=True)
...
# ════════════════════════════════════════
with right_col:
    st.markdown('<div style="padding:32px 40px 36px;">', unsafe_allow_html=True)
