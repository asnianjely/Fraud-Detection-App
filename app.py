...
.block-container { padding: 0 32px 0 0 !important; max-width: 100% !important; }
...
.rec-text { font-size: 13px; color: #5A6478; line-height: 1.6; }
...
# ════════════════════════════════════════
with right_col:
    st.markdown('<div style="padding:32px 48px 36px 40px;">', unsafe_allow_html=True)
