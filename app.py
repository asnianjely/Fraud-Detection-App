...
.topbar-divider {
    ...
    background: #E5E9F2; margin: 0 12px;
}
.topbar-subtitle {
...
.topbar-badge {
    ...
    background: #F4F6FA; border: 1px solid #E5E9F2;
    border-radius: 6px; padding: 5px 10px;
    font-family: 'IBM Plex Mono', monospace;
    font-size: 10px; color: #6B7280; letter-spacing: 0.08em;
}
.topbar-badge span { color: #111827; font-weight: 500; }
.pulse {
...
.verdict-desc { font-size: 13px; color: #6B7280; line-height: 1.6; }
.verdict-chip {
...
.factor-row {
    ...
    padding: 11px 16px; border-bottom: 1px solid #F9FAFB; gap: 12px;
}
...
.factor-name {
    flex: 1; font-size: 12px; color: #374151; font-weight: 400;
}
.factor-bar-track {
    width: 80px; height: 4px;
    background: #F0F2F7; border-radius: 99px; position: relative;
}
...
.placeholder-icon {
    ...
    background: #F0F2F7; display: flex; align-items: center;
    justify-content: center; margin-bottom: 4px;
}
.placeholder-title {
    font-family: 'Sora', sans-serif;
    font-size: 20px; font-weight: 600; color: #D1D5DB;
}
.placeholder-sub {
    font-family: 'IBM Plex Mono', monospace;
    font-size: 11px; color: #E5E7EB; letter-spacing: 0.1em; text-transform: uppercase;
}
...
with right_col:
    ...
    if r is None:
        ...
        <div class="placeholder-wrap">
          <div class="placeholder-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="#D1D5DB" stroke-width="1.8" stroke-linecap="round">
              <path d="M12 2L3 7v5c0 5 4 9.27 9 10.93C17 21.27 21 17 21 12V7L12 2z"/>
            </svg>
          </div>
        ...
        <div class="factor-wrap">
          <div class="factor-head">Risk Factor Breakdown</div>
          {rows}
        </div>""", unsafe_allow_html=True)
